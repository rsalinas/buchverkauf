...
public class ReportVerlagBestellung2 {
	String headers[] = { "Klasse", "Verlag", "Titel", "ISBN", "#" };

	public ReportVerlagBestellung2(DsvBuecher parent) throws SQLException,
	...
	public class KlasseBuch {
		...
		private ReportVerlagBestellung2 getOuterType() {
			return ReportVerlagBestellung2.this;
		}
