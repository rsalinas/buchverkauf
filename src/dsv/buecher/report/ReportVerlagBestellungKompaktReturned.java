...
public class ReportVerlagBestellungKompaktReturned {
	String headers[] = { "#", "Titel", "Verlag", "ISBN",
			BestelllisteStaticized.klassenCaption };

	public ReportVerlagBestellungKompaktReturned(DsvBuecher parent)
			throws SQLException, MalformedURLException, IOException,
			DocumentException {
		DsvBuecherDatasource ds = parent.ds;
		File fich = File.createTempFile("BestListeResid", ".pdf");
		{
			// String fich = "c:/x.pdf";
			...
			for (String land : new String[] { "e", "d", "l" }) {
...

				{
					...
					final Phrase p3 = new Phrase(
							"Zurückgegebene Bücher (übrig). Aus: "
